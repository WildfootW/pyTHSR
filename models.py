...
class Generator:
    ...
    def build_model(self, res_cnt, needSum = False):
        ...
        nn = conv2d(nn, self.img_size[2], (7, 7), strides=(1, 1), norm=False, relu=False, padding='valid' if res_cnt == 6 else 'same')
...
class CycleGAN:
    ...
    def __init__(self, ngf = 32, ndf = 64, shape = (256, 256, 3), bch_img_num = 10, ps = 50, task_name='apple2orange', pic_dir=None):
        ...
        self.MAX_NUM = MinImgCount(task_name = self.task_name)
